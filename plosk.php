...
function stroka_endova(i,nam){
	...
	id3="d"+i;
	document.getElementById("d"+i).className = "open";
	document.getElementById("d"+i).innerHTML="Расстояние от перелива до ближайшего водостока&nbsp;<INPUT type='hidden' value='1' name="+name1+">&nbsp;<INPUT type='text' name="+name2+" id="+name2+" onblur='stroka_endova("+i+",this.name)' size=3> м";
	document.getElementById(name2).value = 0;
	}
};
...
<fieldset><legend>&nbsp;Наружные водосточные трубы диаметром 100 мм и менее&nbsp;</legend>
...
<fieldset><legend>&nbsp;Наружные водосточные трубы диаметром более 100 мм&nbsp;</legend>
...
<fieldset><legend>&nbsp;Переливы&nbsp;</legend>
<div id="d2">Расстояние от перелива до ближайшего водостока&nbsp;<INPUT type="hidden" value="1" name="k[2]">&nbsp;<INPUT type="text" name="l[2]" id="l[2]" onchange="stroka_endova(2,this.name)" size=3> м</div>
...
<fieldset><legend>&nbsp;Внутренние водостоки&nbsp;</legend>
<div>Количество внутренних водосточных труб&nbsp;<INPUT type="hidden" value="plosk.htm" name="adres">&nbsp;<INPUT type="text" name="k[3]" onchange="chSquare(this.name)" size=3></div>
</fieldset>
...
<center>
<input class="red" type="submit" value="Рассчитать">&nbsp;&nbsp;<input class="red" onclick="javascript:window.location.href='plosk.php'" type="button" value="Очистить">
</center>
